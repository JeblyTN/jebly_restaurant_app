      ...
      if (Constant.isPointInPolygon(selectedLocation!, selectedZone.value.area!)) {
        ...
        if (Constant.userModel?.vendorID?.isNotEmpty == true) {
          await FireStoreUtils.updateVendor(vendorModel.value).then((value) {
            ...
            ShowToastDialog.showToast("Restaurant details save successfully".tr);
          ...
          vendorModel.value.workingHours = [
            WorkingHours(day: 'Monday'.tr, timeslot: [Timeslot(from: '00:00', to: '23:59')]),
            WorkingHours(day: 'Tuesday'.tr, timeslot: [Timeslot(from: '00:00', to: '23:59')]),
            WorkingHours(day: 'Wednesday'.tr, timeslot: [Timeslot(from: '00:00', to: '23:59')]),
            WorkingHours(day: 'Thursday'.tr, timeslot: [Timeslot(from: '00:00', to: '23:59')]),
            WorkingHours(day: 'Friday'.tr, timeslot: [Timeslot(from: '00:00', to: '23:59')]),
            WorkingHours(day: 'Saturday'.tr, timeslot: [Timeslot(from: '00:00', to: '23:59')]),
            WorkingHours(day: 'Sunday'.tr, timeslot: [Timeslot(from: '00:00', to: '23:59')])
          ];
