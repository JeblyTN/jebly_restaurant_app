...
class DineInCreateController extends GetxController {
      ...
      (value) {
        if (value != null) {
          ...
          if (vendorModel.value.openDineTime != null &&
            ...
            endDateDateController.value.text =
                vendorModel.value.closeDineTime.toString();
          }
  ...
  Future<void> saveDetails() async {
    ...
    await FireStoreUtils.updateVendor(vendorModel.value).then(
      (value) {
        ShowToastDialog.showToast("Dine In Details save".tr);
      },
    );
  }
