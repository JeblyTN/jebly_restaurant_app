...
class OnBoardingController extends GetxController {
  ...
  Future<void> getOnBoardingData() async {
    ...
    // onBoardingList.add(OnBoardingModel(id: "",title: "Welcome to Jebly Restaurant",description: "Manage your restaurant orders, reservations, and menu effortlessly all in one place.",image: "assets/images/image_1.png"));
