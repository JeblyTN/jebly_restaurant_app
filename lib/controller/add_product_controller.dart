...
class AddProductController extends GetxController {
  ...
  Future<void> generateTitleAndDescription() async {
    ...
    await API.handleApiRequest(request: () => http.post(Uri.parse(API.generateTitleAndDescription), headers: API.headers, body: jsonEncode(bodyParams)), showLoader: false).then(
      (value) {
  ...
  Future<void> generateVariationData() async {
    ...
    await API.handleApiRequest(request: () => http.post(Uri.parse(API.generateVariationData), headers: API.headers, body: jsonEncode(bodyParams)), showLoader: false).then(
      (value) {
  ...
  Future<void> generateIngredients() async {
    ...
    log("Body Params :: $bodyParams");
    await API.handleApiRequest(request: () => http.post(Uri.parse(API.generateIngredients), headers: API.headers, body: jsonEncode(bodyParams)), showLoader: false).then(
      (value) {
  ...
  Future<void> generateSpecification() async {
    ...
    log("Body Params :: $bodyParams");
    await API.handleApiRequest(request: () => http.post(Uri.parse(API.generateSpecification), headers: API.headers, body: jsonEncode(bodyParams)), showLoader: false).then(
      (value) {
  ...
  Future<void> generateAddOns() async {
    ...
    log("Body Params :: $bodyParams");
    await API.handleApiRequest(request: () => http.post(Uri.parse(API.generateAddons), headers: API.headers, body: jsonEncode(bodyParams)), showLoader: false).then(
      (value) {
