...
import 'package:restaurant/payment/rozorpayConroller.dart';
                ...
                onPress: () async {
                  if (controller.selectedPaymentMethod.value == '') {
                    ...
                    if (controller.selectedPaymentMethod.value == PaymentGateway.stripe.name) {
                      ...
                      await RazorPayController().createOrderRazorPay(amount: controller.totalAmount.value.toString(), razorpayModel: controller.razorPayModel.value).then((value) {
                        if (value == null) {
                          Get.back();
