...
import 'package:restaurant/controller/admin_product_controller.dart';
import 'package:restaurant/models/product_model.dart';
import 'package:restaurant/models/tax_model.dart';
import 'package:restaurant/themes/app_them_data.dart';
import 'package:restaurant/themes/responsive.dart' show Responsive;
                ...
                Expanded(
                  child: controller.isLoading.value
                      ...
                      : controller.productList.isEmpty == true
                          ? Constant.showEmptyView(message: "No Result Found".tr)
                          : Padding(
                              padding: const EdgeInsets.symmetric(horizontal: 16),
                                              ...
                                              RoundedButtonFill(
                                                ...
                                                onPress: () async {
                                                  if ((Constant.isSubscriptionModelApplied == true || Constant.adminCommission?.isEnabled == true) &&
                                                      ...
                                                      int.parse(controller.vendorModel.value.subscriptionPlan?.itemLimit != null &&
                                                                  controller.vendorModel.value.subscriptionPlan?.itemLimit.toString() != "null"
...
class TaxBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: themeChange.getThem() ? AppThemeData.grey900 : AppThemeData.surface,
      ...
      child: Column(
        children: [
          ...
          Text(
            "Note: Tax selection is optional. You can add taxes later from manage product section.".tr,
            style: TextStyle(fontSize: 14, fontFamily: AppThemeData.regular),
          ),
          SizedBox(height: 5),
          const Divider(),
