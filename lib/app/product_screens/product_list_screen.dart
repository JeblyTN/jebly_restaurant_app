                    ...
                    : InkWell(
                        ...
                        onTap: () {
                          if (controller.vendorModel.value.id == null) {
                            ShowToastDialog.showToast("Please add your restaurant details before creating a product.".tr);
                          } else {
          ...
          children: [
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(title.tr, style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w600)),
