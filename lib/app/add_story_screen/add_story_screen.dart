            ...
            bottomNavigationBar: Container(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    if ((controller.storyModel.value.videoThumbnail?.isNotEmpty == true || controller.storyModel.value.videoUrl.isNotEmpty == true))
                      InkWell(
                        onTap: () async {
                          ShowToastDialog.showLoader("Please wait".tr);
                          await FireStoreUtils.removeStory(Constant.userModel!.vendorID.toString()).then((value) async {
                            ShowToastDialog.closeLoader();
                            ShowToastDialog.showToast("Story remove successfully".tr);
                            await controller.getStory();
                            controller.thumbnailFile.value = <dynamic>[];
                            controller.mediaFiles.value = <dynamic>[];
                          });
                        },
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
