                                            ...
                                            children: [
                                              Expanded(
                                                ...
                                                onTap: () async {
                                                  ...
                                                  controller.workingHours[index].timeslot![indexTimeSlot].from =
                                                  ...
                                                  if (endTimeOfDay != null) {
                                                    ...
                                                    if (startTime.isAfter(endTime)) {
                                                      ...
                                                      if (endTimeOfDay.format(context).toString() == "12:00 AM") {
                                                        ...
                                                        controller.workingHours[index].timeslot![indexTimeSlot].to =
                                                            DateFormat('HH:mm').format(DateTime(DateTime.now().year, DateTime.now().month, DateTime.now().day, endTimeOfDay.hour, endTimeOfDay.minute));
                                                      }
                                                    }
                                                  }
                                                },
