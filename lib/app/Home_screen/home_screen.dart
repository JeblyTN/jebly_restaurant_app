                        ...
                        : controller.userModel.value.vendorID == null || controller.userModel.value.vendorID!.isEmpty
                            ...
                            : Padding(
                                ...
                                child: Constant.getEmployeeRolePermission(module: "Manage Order") == true
                                    ? TabBarView(
                                        children: [
                                          controller.newOrderList.isEmpty
                                              ? Constant.showEmptyView(message: "New Orders Not found".tr)
                                              : ListView.builder(
                                                  shrinkWrap: true,
                                          ...
                                          controller.acceptedOrderList.isEmpty
                                              ? Constant.showEmptyView(message: "Accepted Orders Not found".tr)
                                              : ListView.builder(
                                                  shrinkWrap: true,
                                          ...
                                          controller.completedOrderList.isEmpty
                                              ? Constant.showEmptyView(message: "Completed Orders Not found".tr)
                                              : ListView.builder(
                                                  shrinkWrap: true,
                                          ...
                                          controller.rejectedOrderList.isEmpty
                                              ? Constant.showEmptyView(message: "Rejected Orders Not found".tr)
                                              : ListView.builder(
                                                  shrinkWrap: true,
                                          ...
                                          controller.cancelledOrderList.isEmpty
                                              ? Constant.showEmptyView(message: "Cancelled Orders Not found".tr)
                                              : ListView.builder(
                                                  shrinkWrap: true,
                                    ...
                                    : Constant.showEmptyView(message: "You don’t have permission to view orders.".tr),
                              ),
                  ),
                );
        });
                    ...
                    children: [
                        ...
                        child: RoundedButtonFill(
                          ...
                          onPress: () async {
                            ...
                            if (orderModel.paymentMethod!.toLowerCase() != 'cod') {
                              ...
                              if (orderModel.isFreeDelivery == true) {
                                finalAmount = (subTotal + double.parse(orderModel.discount.toString()) + specialDiscount + double.parse(taxAmount.toString()));
                              } else {
                                finalAmount = (subTotal + double.parse(orderModel.discount.toString()) + specialDiscount + double.parse(taxAmount.toString())) +
                            ...
                            if (orderModel.adminCommission != '0' && orderModel.adminCommission != '' && orderModel.adminCommission != null) {
                              finalAmount = (subTotal / (1 + (double.parse(orderModel.adminCommission!) / 100))) - double.parse(orderModel.discount.toString()) - specialDiscount;
                            } else {
                      ...
                      Expanded(
                        child: orderModel.takeAway == true
                            ...
                            : RoundedButtonFill(
                                title: orderModel.status.toString().tr,
                                color: AppThemeData.secondary300,
                                textColor: AppThemeData.grey50,
                                height: 5,
                                onPress: () async {},
                ...
                child: DropdownSearch<UserModel>(
                  ...
                  onChanged: (UserModel? value) {
                    ...
                    if (Constant.singleOrderReceive == true && value.inProgressOrderID?.isNotEmpty == true) {
                      ShowToastDialog.showToast(
                        "This delivery man is already assigned. Kindly select a different one.".tr,
                      );
                      return;
                    }
