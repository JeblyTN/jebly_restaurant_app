                    ...
                    Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text("Ad Status".tr, style: TextStyle(fontFamily: AppThemeData.medium, fontSize: 14, color: themeChange.getThem() ? AppThemeData.grey100 : AppThemeData.grey800)),
                        ),
                        const SizedBox(
                          height: 5,
                        ),
                          ...
                          child: Column(
                            children: [
                              ...
                              Visibility(
                                ...
                                child: buildRow(label: 'Ad Paused Note:'.tr, value: controller.advertisementModel.value.pauseNote ?? '', isDarkMode: themeChange.getThem()),
                              ),
                              Visibility(
                                  visible: controller.advertisementModel.value.status == Constant.adsCancel,
                                  child: buildRow(label: 'Ad Cancel Note:'.tr, value: controller.advertisementModel.value.canceledNote ?? '', isDarkMode: themeChange.getThem()))
                            ],
                          ),
                        ),
                      ],
                        ...
                        children: [
                          ...
                          Visibility(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("Profile Image".tr, style: TextStyle(fontFamily: AppThemeData.medium, fontSize: 14, color: themeChange.getThem() ? AppThemeData.grey100 : AppThemeData.grey800)),
                                const SizedBox(
                                  height: 5,
                                ),
                                Row(
                          ...
                          Visibility(
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              Text("Cover Image".tr, style: TextStyle(fontFamily: AppThemeData.medium, fontSize: 14, color: themeChange.getThem() ? AppThemeData.grey100 : AppThemeData.grey800)),
