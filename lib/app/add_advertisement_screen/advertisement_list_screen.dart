          ...
          return DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                actions: [
                  if (controller.venderModel.value.subscriptionPlan?.features?.chat == true)
                    InkWell(
                  ...
                  : Padding(
                      ...
                      child: TabBarView(children: [
                        controller.allAdvertisementList.isEmpty
                            ? Constant.showEmptyView(message: "Advertisement not found.".tr)
                            : RefreshIndicator(
      ...
      return Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            Text('Ad Created Successfully!'.tr, style: TextStyle(color: themeChange.getThem() ? AppThemeData.grey50 : AppThemeData.grey900, fontFamily: AppThemeData.semiBold, fontSize: 16)),
            SizedBox(height: 12),
            Text(
              ...
              style: TextStyle(color: themeChange.getThem() ? AppThemeData.grey50 : AppThemeData.grey900, fontFamily: AppThemeData.medium, fontSize: 14),
            ),
            SizedBox(height: 24),
            RoundedButtonFill(
              radius: 6,
                    ...
                    itemBuilder: (context) => [
                      if ((model.status == Constant.adsApproved || model.status != Constant.adsUpdated) && !model.endDate!.toDate().isBefore(DateTime.now()))
                        model.isPaused == true
                            ? PopupMenuItem(
                                onTap: () {
                                  controller.resumeAdvertisement(model, index, context, themeChange.getThem());
                                },
                                value: 'resume',
                                child: Row(
                                  children: [
                            ...
                            : PopupMenuItem(
                                onTap: () {
                                  ...
                                  controller.pauseAdvertisement(model, index, context, themeChange.getThem());
                                },
                                value: 'pause',
                                child: Row(
                                  children: [
                      ...
                      PopupMenuItem(
                        onTap: () async {
                          controller.deleteAdvertisement(model, index, context, themeChange.getThem());
                        },
                        value: 'delete',
                        child: Row(
                          children: [
                ...
                if (model.type != 'video_promotion' && (model.showRating == true || model.showReview == true))
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          model.showRating == true ? Icon(Icons.star, color: AppThemeData.outrageous300, size: 16) : SizedBox(),
                          SizedBox(width: 4),
                          Text(
                            ...
                            style: TextStyle(color: AppThemeData.outrageous300, fontWeight: FontWeight.bold),
                          ),
                        ],
                      ),
                    ),
                      ...
                      children: [
                        ...
                        model.type == 'restaurant_promotion'
                            ...
                            : Container(
                                ...
                                child: Padding(padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4), child: Icon(Icons.arrow_forward, size: 20, color: AppThemeData.secondary300))),
                      ],
                    ),
                  ),
                  // IconButton(
