...
class AddAdvertisementScreen extends StatelessWidget {
        ...
        builder: (controller) {
          return Scaffold(
            appBar: AppBar(
                ...
                centerTitle: false,
                titleSpacing: 0,
                iconTheme: IconThemeData(color: AppThemeData.grey100, size: 20),
                title: Text(
                  "Your Advertisement".tr,
                  style: TextStyle(color: AppThemeData.grey100, fontSize: 18, fontFamily: AppThemeData.medium),
                )),
                      ...
                      child: Column(
                        ...
                        children: [
                          TextFieldWidget(
                            ...
                            controller: controller.advertisementTitleController.value,
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              DropdownButtonFormField<String>(
                                  ...
                                  initialValue:
                                      controller.selectedAdvertisementType.value == '' || controller.selectedAdvertisementType.value.isEmpty ? null : controller.selectedAdvertisementType.value,
                                  onChanged: (value) {
                                    controller.selectedAdvertisementType.value = value!;
                                    controller.update();
                                  },
                                  ...
                                  items: controller.advertisementType.map((name) {
                          ...
                          Column(
                            children: [
                              ...
                              TextFieldWidget(
                                  ...
                                  isReadyOnly: true,
                                  onClick: () {
                                    dateValidityPicker(context, controller, themeChange.getThem());
                                  },
                                  title: 'Validity:'.tr,
                            ...
                            child: Column(
                              ...
                              children: [
                                Text("Upload Related Files".tr,
                                    style: TextStyle(fontFamily: AppThemeData.semiBold, fontSize: 16, color: themeChange.getThem() ? AppThemeData.grey100 : AppThemeData.grey800)),
                                const SizedBox(
                                  height: 5,
                                ),
                                Row(
                                  children: [
                                    controller.profileImage.value.path.isEmpty && controller.profileImageString.value == ''
                                        ? InkWell(
                                            ...
                                            child: Container(
                                              decoration: BoxDecoration(
                                                border: Border.all(width: 1, color: themeChange.getThem() ? AppThemeData.grey600 : AppThemeData.grey200),
                                                      ...
                                                      children: [
                                                        ClipRRect(
                                                          ...
                                                          child: controller.profileImage.value.runtimeType == XFile && controller.profileImageString.value == ''
                                                              ...
                                                              : NetworkImageWidget(
                                                                  imageUrl: controller.profileImageString.value,
                                                                  fit: BoxFit.cover,
                                                                  width: Responsive.width(30, context),
                                                                  height: Responsive.width(30, context),
                                                                ),
                                                  ...
                                                  children: [
                                                    ClipRRect(
                                                      ...
                                                      child: controller.coverImage.value.runtimeType == XFile && controller.coverImageString.value == ''
                                                          ...
                                                          : NetworkImageWidget(
                                                              imageUrl: controller.coverImageString.value,
                                                              fit: BoxFit.cover,
                                                              height: Responsive.height(20, context),
                                                              width: Responsive.width(90, context),
                                                            ),
                                          ...
                                          child: Padding(
                                            ...
                                            child: Stack(
                                              children: [
                                                ClipRRect(
                                                    borderRadius: const BorderRadius.all(Radius.circular(10)),
                                                    child: controller.thumbnailFile.value.runtimeType == XFile && controller.thumbnailFileString.value == ''
                                                        ? VideoAdvWidget(width: MediaQuery.of(context).size.width, url: File(controller.thumbnailFile.value.path))
                                                        : VideoAdvWidget(width: MediaQuery.of(context).size.width, url: controller.thumbnailFileString.value)),
                                                Positioned(
                                                  top: 8,
                                                  right: 8,
                                                  child: InkWell(
                ...
                Expanded(
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: RoundedButtonFill(
                        radius: 12,
                        title: controller.advertisementModel.value.id != null ? "Edit & Save".tr : "Submit".tr,
                        height: 5.5,
  ...
  Future<dynamic> buildProfileBottomSheet(BuildContext context, AddAdvertisementController controller) {
                    ...
                    children: [
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            IconButton(
                                onPressed: () => controller.profilePickFile(source: ImageSource.camera),
                                icon: const Icon(
                                  Icons.camera_alt,
                                  size: 32,
                                )),
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            IconButton(
                                onPressed: () => controller.profilePickFile(source: ImageSource.gallery),
                                icon: const Icon(
  ...
  Future<dynamic> buildCoverBottomSheet(BuildContext context, AddAdvertisementController controller) {
    return showModalBottomSheet(
        context: context,
        builder: (context) {
          final themeChange = Provider.of<DarkThemeProvider>(context);
                    ...
                    children: [
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            IconButton(
                                onPressed: () => controller.coverPickFile(source: ImageSource.camera),
                                icon: const Icon(
                                  Icons.camera_alt,
                                  size: 32,
                                )),
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            IconButton(
                                onPressed: () => controller.coverPickFile(source: ImageSource.gallery),
                                icon: const Icon(
                                  Icons.photo_library_sharp,
                                  size: 32,
                                )),
...
Future<dynamic> dateValidityPicker(BuildContext context, AddAdvertisementController controller, bool isDarkMode) {
  return showModalBottomSheet(
    context: context,
    builder: (BuildContext context) {
      return Container(
        ...
        child: Column(
          children: [
            SfDateRangePicker(
              backgroundColor: isDarkMode ? AppThemeData.grey900 : AppThemeData.grey50,
