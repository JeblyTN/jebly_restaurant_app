            ...
            body: Padding(
              ...
              child: controller.isLoading.value
                  ...
                  : controller.offerList.isEmpty
                      ? Constant.showEmptyView(message: "No Offer found".tr)
                      : ListView.builder(
                                              ...
                                              children: [
                                                DottedBorder(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: Text(
                                                        "${couponModel.code}".tr,
                                                        style: TextStyle(color: themeChange.getThem() ? AppThemeData.grey200 : AppThemeData.grey700, fontSize: 18, fontFamily: AppThemeData.medium),
                                                      ),
                                                    ),
                                                  ),
                                                ),
                                                ...
                                                Text(
                                                  (couponModel.discountType == "Fix Price"
                                                      ...
                                                      .tr,
                                                  style: TextStyle(color: themeChange.getThem() ? AppThemeData.secondary300 : AppThemeData.secondary300, fontSize: 14, fontFamily: AppThemeData.medium),
                                                )
                                              ],
                                            ),
                                          ),
