...
import 'package:restaurant/app/change_password_screen/change_password_screen.dart';
...
import 'package:restaurant/app/employee_role_screens/role_screen.dart';
import 'package:restaurant/app/employee_screens/employee_list_screen.dart';
...
class ProfileScreen extends StatelessWidget {
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                                            ...
                                            FutureBuilder<EmployeeRoleModel?>(
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                return Container(
                                                  ...
                                                  child: Text(
                                                    role?.title ?? '', // use actual field from EmployeeRoleModel
                                                    style: TextStyle(
                                                      fontSize: 14,
                                                      color: themeChange.getThem() ? AppThemeData.grey50 : AppThemeData.grey900,
                                                      fontFamily: AppThemeData.semiBold,
                          ...
                          if (Constant.getEmployeeRolePermission(module: "Add Story") == true ||
                              Constant.getEmployeeRolePermission(module: "Advertisement") == true ||
                              Constant.getEmployeeRolePermission(module: "Restaurant Information's") == true ||
                                                    ...
                                                    () {
                                                      ...
                                                      if (controller.userModel.value.role == Constant.userRoleVendor) {
                                                        dashBoardController.selectedIndex.value =
                                                            Constant.isDineInEnable && dashBoardController.venderModel.value?.subscriptionPlan?.features?.dineIn == true ? 2 : 1;
                                                      } else {
                                                        dashBoardController.selectedIndex.value = Constant.getEmployeeRolePermission(module: "Dine in Request") == true &&
                                                                Constant.isDineInEnable &&
                                                                dashBoardController.venderModel.value?.subscriptionPlan?.features?.dineIn == true
                                                            ? 2
                                                            : 1;
                                                      }
                                                    },
                          ...
                          if (Constant.isSelfDeliveryFeature == true && (Constant.getEmployeeRolePermission(module: "Manage Delivery Man") == true))
                          ...
                          ((Constant.isRestaurantVerification == true && controller.userModel.value.isDocumentVerify == false) ||
                                      ...
                                      (controller.userModel.value.role == Constant.userRoleVendor && controller.userModel.value.subscriptionPlan?.features?.dineIn == false)) ||
                              ...
                              : Constant.isDineInEnable &&
                                  ...
                                  : const SizedBox(),
                          if ((Constant.getEmployeeRolePermission(module: "Subscription Packages") == true) || (Constant.getEmployeeRolePermission(module: "Subscription History") == true))
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                const SizedBox(
                                  ...
                                  cardDecoration(
                                    ...
                                    () {
                                      Get.to(HelpSupportScreen(
                                        isNavigateViaNotification: false,
                                      ));
                                    },
                                  ),
                                  cardDecoration(
                                ...
                                children: [
                                  ...
                                  cardDecoration(
                                      ...
                                      Container(
                                          ...
                                          child: Padding(padding: const EdgeInsets.all(10), child: SvgPicture.asset("assets/icons/ic_logout.svg"))),
                                      "Log out", () {
                                    showDialog(
                                        context: context,
  ...
  Padding cardDecoration(themeChange, ProfileController controller, Widget image, String title, Function()? onPress) {
    return Padding(
